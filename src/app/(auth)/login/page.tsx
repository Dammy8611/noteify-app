  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Login Failed',
        description: 'Invalid credentials. Please try again or use the account recovery option.',
      });
    } finally {
      setIsLoading(false);
    }
    ...
    <>
      <Card>
        ...
        <CardContent>
          ...
          <Button variant="outline" className="w-full" onClick={handleGoogleRecovery}>
